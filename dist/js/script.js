...
window.addEventListener('DOMContentLoaded', () => {
  ...
  new MenuCard('img/tabs/post.jpg', 'elite', 'Меню “Постное”', `Меню “Постное” - это
        ...
        белков за
        счет тофу и импортных вегетарианских стейков.`, 15, '.menu .container', 'menu__item').render(); // Forms
